        ...
        <div className="report-container" >
            ...
            <div className="report-background" />
                ...
                <div className="report-content-mobile-button-section">
                    <button className="report-login-btn" style={{margin: '10px'}}>LOGIN</button>
                    <p style={{color: 'white',zIndex: '1', alignSelf: 'center'}}>Or</p>
                    <button className="report-signup-btn" style={{margin: '10px'}}>SIGN UP</button>
                </div>
                </div>
                </MediaQuery>
        </div>
