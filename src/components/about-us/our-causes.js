    ...
    return (
      <div className="our-causes-cards-wrapper">
        ...
        <div className="card-wrapper">
          ...
          <p>
            Education in Nigeria is far below the expected standard and cannot
            be effectively used as a weapon in the fight against poverty. This
            is why we have channeled our nergies to improving the quality of
        ...
        <div className="card-wrapper">
          ...
          <p>
            ...
            education issues and actively contribute to providing solutions to
            the many problems in the sector as an active citizen.
          </p>
        </div>
        ...
        <div className="card-wrapper">
          ...
          <p>
            The overall responsibility to provide quality education lies with
            the government. Unfortunately, the government has not been open to
  ...
  render() {
    ...
    return (
      <div className="our-causes" style={window.innerWidth<=1100?styles:{}}>
        ...
        {window.innerWidth > 1100 && this.NormalView()}
        {window.innerWidth <= 1100 && this.MobileView()}
      </div>
    );
  }
}
